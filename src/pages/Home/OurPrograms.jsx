                  ...
                  <div className="relative card-body text-center">
                    ...
                    <div>
                      ...
                      <p className="text-[#a4a9b9] text-base font-Poppins">
                        Short loin andouille bresaola, swine jowl beef ribs
                        venison capicola jerky ham pig.
                      </p>
                      <div className=" hover:translate-y-3 transition delay-100 ease-in cursor-pointer">
                        <AiOutlineArrowDown className="mx-auto mt-3  text-[#e43d49]  "></AiOutlineArrowDown>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="w-[365px] f-[505px] bg-base-100 shadow-xl">
                  ...
                  <div className="relative card-body text-center">
                    ...
                    <div>
                      ...
                      <p className="text-[#a4a9b9] text-base font-Poppins">
                        Salami turkey beef ribs hamburger. Pork loin capicola
                        tri-tip pork chop strip.
                      </p>
                      <div className=" hover:translate-y-3 transition delay-100 ease-in cursor-pointer">
                        <AiOutlineArrowDown className="mx-auto mt-3  text-[#e43d49]  "></AiOutlineArrowDown>
                      </div>
                ...
                <div className="w-[365px] f-[505px] bg-base-100 shadow-xl">
                  ...
                  <div className="relative card-body text-center">
                    ...
                    <div>
                      ...
                      <p className="text-[#a4a9b9] text-base font-Poppins">
                        Ribeye kevin shank bacon bris fatback. Sirloin
                        frankfurter brisket, tri-tip pork chicken.
                      </p>
                      <div className=" hover:translate-y-3 transition delay-100 ease-in cursor-pointer">
                        <AiOutlineArrowDown className="mx-auto mt-3  text-[#e43d49]  "></AiOutlineArrowDown>
                      </div>
                ...
                <div className="w-[365px] f-[505px] bg-base-100 shadow-xl">
                  ...
                  <div className="relative card-body text-center">
                    ...
                    <div>
                      ...
                      <p className="text-[#a4a9b9] text-base font-Poppins">
                        Filet mignon bresaola doner, buffalo pork belly meatball
                        meatl swine sirloin.
                      </p>
                      <div className=" hover:translate-y-3 transition delay-100 ease-in cursor-pointer">
                        <AiOutlineArrowDown className="mx-auto mt-3  text-[#e43d49]  "></AiOutlineArrowDown>
